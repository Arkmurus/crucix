...
// RELATIONSHIP_SCORE: How strong is Arkmurus's position in this market?
// 20-25 = Incumbent (Lusophone core — we ARE the go-to)
// 10-15 = Established presence (regular engagement, known to MoD)
// 5-9   = Developing (some contacts, building relationships)
// 1-4   = Cold entry (no existing relationships, competing from scratch)
const ARKMURUS_RELATIONSHIP = {
  // TIER 1: INCUMBENT — Lusophone core (genuine competitive moat)
  lusophone: 25, angola: 22, mozambique: 20, portugal: 18,
  'guinea-bissau': 16, 'cape verde': 14, 'sao tome': 14, brazil: 12,
  // TIER 2: ESTABLISHED — regular engagement markets
  'south africa': 10, kenya: 8, nigeria: 8, sadc: 10,
  // TIER 3: DEVELOPING — some contacts, building presence
  senegal: 6, ghana: 5, rwanda: 5, uganda: 5, tanzania: 5,
  'cote d\'ivoire': 5, cameroon: 4, ethiopia: 4, libya: 3,
  // TIER 4: COLD ENTRY — intelligence-driven, no existing relationships
...
// MARKET_OPPORTUNITY: How strong is the procurement opportunity regardless of Arkmurus?
// This is pure market assessment — conflict intensity, budget health, modernisation momentum
// Scored separately so the brain knows "great opportunity but we have no edge there"
const ARKMURUS_STRENGTHS = {
  // These are COMBINED scores (relationship + capability) for backward compatibility
  // with scoreWinProbability() which uses this object directly
  lusophone: 25, angola: 22, mozambique: 20, portugal: 18,
  'guinea-bissau': 16, 'cape verde': 14, 'sao tome': 14, brazil: 12,
  'south africa': 10, kenya: 8, nigeria: 8, sadc: 10,
  senegal: 6, ghana: 5, rwanda: 5, uganda: 5, tanzania: 5,
  ...
  // Capability strengths (product-market fit)
...
For Lusophone markets — leverage the deep relationship advantage and Portuguese language.
For cold-entry markets — specify the entry strategy, local partner need, and realistic timeline.
