  ...
  try {
    ...
    try { return JSON.parse(clean(candidate)); }
      ...
      try { return JSON.parse(nuclear); }
        ...
        console.error('[BD] JSON repair failed after 5 strategies. Input preview:', s.slice(0, 300));
        throw new Error('JSON parse failed after 5 repair strategies: ' + e2.message);
      }
    }
  }
}
