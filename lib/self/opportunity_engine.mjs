...
export async function detectOpportunities(currentData) {
  ...
  for (const market of TARGET_MARKETS) {
    ...
    // Tier floor: HIGH strategic-priority markets are never below MEDIUM (they're pre-positioned core markets)
    let calcTier = score >= 65 ? 'HIGH' : score >= 35 ? 'MEDIUM' : 'WATCH';
    if (market.priority === 'HIGH'   && calcTier === 'WATCH')  calcTier = 'MEDIUM';
    opportunities.push({
