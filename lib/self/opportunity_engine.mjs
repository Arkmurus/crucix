...
// Lusophone Africa + West Africa priority markets
const TARGET_MARKETS = [
  ...
  { name: 'Mali',          iso2: 'ML', lusophone: false, priority: 'MEDIUM', riskLevel: 5 },
  { name: 'Burkina Faso',  iso2: 'BF', lusophone: false, priority: 'MEDIUM', riskLevel: 5 },
  { name: 'Niger',         iso2: 'NE', lusophone: false, priority: 'LOW',    riskLevel: 5 },
];
