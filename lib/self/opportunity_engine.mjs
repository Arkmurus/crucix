...
export async function detectOpportunities(currentData) {
  ...
  for (const market of TARGET_MARKETS) {
    ...
    // The old fallback (market.strategicNeeds || ['small arms','ammunition',
    // 'communications']) recommended OEMs off hand-authored/hardcoded needs when
    // none were actually detected — fabricated OEM recs surfaced in Telegram
