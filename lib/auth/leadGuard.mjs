...
/**
 * Decoy field name. Chosen to look worth filling: a scraper that autofills
 * plausible names will complete "website_url", while a human never sees it.
 *
 ...
 */
export const LEAD_HONEYPOT_FIELD = 'website_url';
