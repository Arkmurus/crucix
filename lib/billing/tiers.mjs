...
export const TIERS = Object.freeze({
  ...
  pro: {
    id: 'pro',
    // R-F2314 — label/price restored to match the landing page (public/index.html):
    // Essentials £79. NOTE: `priceUsd` is the display amount in the landing's
    // currency (GBP); billing is soft-launch (free-tier only) so no live charge is
    // affected. When Stripe is enabled, STRIPE_PRICE_PRO must be a GBP price.
    label: 'Essentials',
    priceUsd: 79,
