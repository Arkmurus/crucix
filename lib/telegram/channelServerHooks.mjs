...
// defence/procurement/geopolitics. That is a scope decision, not an oversight, and
// the R-F3688 test pins it as one — any NEW brain signal_type must be admitted here
// or named in that test's DELIBERATELY_EXCLUDED set, so the next drift is reviewed
// instead of silent.
