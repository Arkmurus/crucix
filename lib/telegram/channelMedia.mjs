...
export function generateInfographicCard(data) {
  ...
  <text x="48" y="374" font-family="DejaVu Sans, system-ui, Segoe UI, sans-serif" font-size="19" font-weight="700" letter-spacing="0" fill="#f3f4f6">${_escapeXml(target.slice(0, 46))}</text>` : ''}
  ...
  <g>
    ...
    <text x="748" y="164" font-family="DejaVu Sans, system-ui, Segoe UI, sans-serif" font-size="20" font-weight="600" letter-spacing="0" fill="#f3f4f6">${_svgLines(impact, 748, 164, 27, 45, 4)}</text>
    ...
    <text x="748" y="364" font-family="DejaVu Sans, system-ui, Segoe UI, sans-serif" font-size="20" font-weight="600" letter-spacing="0" fill="#f3f4f6">${_svgLines(nextCheck, 748, 364, 27, 45)}</text>
  </g>
  ...
  <g>
    ...
    <text x="744" y="${h - 126}" font-family="DejaVu Sans, system-ui, Segoe UI, sans-serif" font-size="16" font-weight="700" letter-spacing="0" fill="#f3f4f6">${_escapeXml(evidenceHost)}</text>
