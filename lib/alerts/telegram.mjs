...
// Europe/London timestamp helper — used in all alert messages
    ...
    for (const c of (data.correlations || [])) {
      if (c.severity === 'critical' || c.severity === 'high') {
        ...
        candidates.push({
          ...
          source:   'correlation',
          priority: c.severity,
          dedupKey: topKey || `corr:${c.region}`, // stable key independent of region prefix
        });
      }
    }
