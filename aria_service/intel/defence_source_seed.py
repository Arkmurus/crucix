...
_DEFENCE_SOURCES: list[tuple[str, str, str, list[str]]] = [
    ...
    ("https://www.entreprises.gouv.fr/fr/dual-use-export-control",
     "fr_sbdu", "tier_1a", ["compliance", "export_control", "france"]),
    ("https://www.uama.esteri.it/", "it_uama",
    ...
    ("https://www.comercio.gob.es/SGCD/SGCD/", "es_sgcd",
    ...
    ("https://www.dapa.go.kr/dapa/en/main/main.do", "kr_dapa",
     "tier_1a", ["compliance", "procurement", "south_korea"]),
    ("https://www.ddpdod.gov.in/", "in_ddp",
    ...
    ("https://www.iadb.org/en/about-us/integrity-and-transparency/sanctions-system",
     "idb_sanctions", "tier_1a", ["compliance", "procurement", "latam"]),
    ("https://www.eib.org/en/about/governance-and-structure/control_audit/oversight/eib-debarment-decisions.htm",
     "eib_debarment", "tier_1a", ["compliance", "procurement", "eu"]),
    ("https://www.isdb.org/integrity-and-transparency",
    ...
    ("https://buyandsell.gc.ca/", "ca_buyandsell",
     "tier_1a", ["procurement", "canada"]),
    ("https://www.koneps.go.kr/eng/", "kr_koneps",
     "tier_1a", ["procurement", "south_korea"]),
    ("https://www.gem.gov.in/", "in_gem",
    ...
    ("https://e-services.companiesoffice.govt.nz/", "nz_companies_office",
    ...
    ("https://sanctionslist.io/", "sanctionslist_io",
     "tier_1b", ["compliance", "sanctions"]),

    # ── Tier 2 — Specialist defence press (specialty + region) ──
    ("https://www.thedrive.com/the-war-zone", "the_war_zone",
    ...
    ("https://www.indiandefensereview.com/", "indian_defence_review",
     "tier_2", ["market_intel", "technical", "india"]),
    ("https://www.scmp.com/", "scmp",
     "tier_2", ["geopolitics", "asia"]),
    ("https://riafan.ru/", "tass_en",  # Russian state press caveat — kept for visibility, tier_4 in scoring
     "tier_2", ["geopolitics", "russia"]),
    ("https://www.macauhub.com.mo/en/", "macauhub",
     "tier_2", ["geopolitics", "lusophone"]),
    ("https://www.lusa.pt/Default.aspx", "lusa",
     "tier_2", ["geopolitics", "lusophone", "portugal"]),
    ("https://novicias.uol.com.br/", "uol_brazil",
    ...
    ("https://elbitsystems.com/pr-new/", "elbit_press",
     "tier_1a", ["market_intel", "israel", "oem"]),
    ("https://www.aselsan.com/en/press-room", "aselsan_press",
     "tier_1a", ["market_intel", "turkey", "oem"]),
    ("https://www.roketsan.com.tr/en/press", "roketsan_press",
     "tier_1a", ["market_intel", "turkey", "oem"]),
    ("https://www.baykartech.com/en/news/", "baykar_press",
     "tier_1a", ["market_intel", "turkey", "oem"]),
    ("https://hal-india.co.in/news_room.aspx", "hal_press",
     "tier_1a", ["market_intel", "india", "oem"]),
    ("https://embraer.com/global/en/news", "embraer_press",
     "tier_1a", ["market_intel", "brazil", "oem"]),
    ("https://www.indracompany.com/en/newsroom", "indra_press",
     "tier_1a", ["market_intel", "spain", "oem"]),
    ("https://www.babcockinternational.com/news/", "babcock_press",
     "tier_1a", ["market_intel", "uk", "oem"]),
    ("https://www.qinetiq.com/en/news", "qinetiq_press",
     "tier_1a", ["market_intel", "uk", "oem"]),
    ("https://www.diehl.com/group/en/press-and-media/", "diehl_press",
     "tier_1a", ["market_intel", "germany", "oem"]),
    ("https://www.hensoldt.net/news/", "hensoldt_press",
     "tier_1a", ["market_intel", "germany", "oem"]),
    ("https://www.helsing.ai/news", "helsing_press",
     "tier_1a", ["market_intel", "germany", "oem"]),
