...
# R-F2119 §21a — wire failure handler for infra_health
try:
    wire_failure(module="infra_health", detail="module shutdown",
                gap_type="engine_failure", source="infra_health:shutdown")
except Exception:
    pass
