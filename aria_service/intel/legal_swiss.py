...
# R-F2119 §21a — wire failure handler for legal_swiss
try:
    wire_failure(module="legal_swiss", detail="module shutdown",
                gap_type="engine_failure", source="legal_swiss:shutdown")
except Exception:
    pass
