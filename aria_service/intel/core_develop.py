...
# R-F2119 §21a — wire failure handler for core_develop
try:
    wire_failure(module="core_develop", detail="module shutdown",
                gap_type="engine_failure", source="core_develop:shutdown")
except Exception:
    pass
