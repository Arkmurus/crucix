...
# R-F2119 §21a — wire failure handler for knowledge_latam_non_lusophone
try:
    wire_failure(module="knowledge_latam_non_lusophone", detail="module shutdown",
                gap_type="engine_failure", source="knowledge_latam_non_lusophone:shutdown")
except Exception:
    pass
