...
# R-F2119 §21a — wire failure handler for legal_turkish
try:
    wire_failure(module="legal_turkish", detail="module shutdown",
                gap_type="engine_failure", source="legal_turkish:shutdown")
except Exception:
    pass
