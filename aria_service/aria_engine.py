...
(R-F558 [2026-05-16] collapsed the original clauses 27-35 — 9 clauses with 3 distinct rules duplicated across attack attributions — into clauses 27/28/29. All 9 R-F168 attack classes remain explicitly listed in the new clauses' "Closes adversarial attacks:" tails so future adversarial amendments can dedupe against them. Operator-approval audit trail for the original 9 entries: 2026-05-15T11:48:40Z through 2026-05-15T12:30:56Z, batch triage post R-F534 ship. Net constitution shrink: ~3.4KB of prompt tokens per request.)
"""
