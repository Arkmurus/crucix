...
export default {
  ...
  llm: {
    ...
    baseUrl:  process.env.OPENAI_BASE_URL || process.env.OLLAMA_BASE_URL || null, // FIX: was only reading OLLAMA_BASE_URL
  },
  ...
  telegram: {
    ...
    // R-F2552 — the public broadcast channel must be explicit. Do not fall back
    // to TELEGRAM_CHAT_ID: that chat is used by private ops/admin bot messages,
    // and public Golden Intel must not share an implicit destination with noise.
