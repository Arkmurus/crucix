...
case "$TRAINING_RECIPE_KIND" in
  tooluse_dpo_continuation|tooluse_dpo_balanced_diagnostic_continuation|tooluse_dpo_balanced_accepted_continuation|tooluse_dpo_boundary_accepted_continuation|tooluse_dpo_protected_frontier_continuation)
