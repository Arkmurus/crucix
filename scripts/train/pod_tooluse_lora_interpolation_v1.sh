#!/usr/bin/env bash
# R-F4164 — evaluate the three pre-registered parent/candidate LoRA interpolations.
set -uo pipefail
...
[ "$ALPHAS" = "0.25 0.5 0.75" ] || fail "alpha set differs from registration"
...
for alpha in $ALPHAS; do
  ...
  report="$EVALD/aria_tooluse_lora_interpolation_v1_alpha_${tag}.json"
